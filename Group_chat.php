...
$link = mysqli_connect("localhost","emgbdev_admin","Eg+-6228456","emgbdev_chat_app");
...
main .inner_div{
    ...
    overflow:auto;
    height:500px;
    background-image:url(https://www.ixpap.com/images/2021/05/minimalist-wallpaper-ixpap-4.jpg);
...
main .triangle1{
    ...
    border-color: transparent
      transparent #72C0BB transparent;
    margin-right:20px;
    float:right;
    clear:both;
}
